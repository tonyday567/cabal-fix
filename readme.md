...
3.  [App Configuration](#orga921360)
4.  [Library Usage](#orgbb0e777)
5.  [cabal init](#orge6fca8d)
...
[Cabal: preferred and deprecated versions | Hackage](https://hackage.haskell.org/package/Cabal/preferred)
...
`package-json` content is a security/signing feature you can read about in [hackage-security](https://github.com/haskell-ng/hackage-security/blob/master/README.md).
...
There are multiple versions of package/versions because of revisions. See [revisions-information.md](https://github.com/haskell-infra/hackage-trustees/blob/master/revisions-information.md)
...
[optics-core: Optics as an abstract interface: core definitions](https://hackage.haskell.org/package/optics-core-0.4.1.1)

[6. Package Description — Cabal 3.10.1.0 User&rsquo;s Guide](https://cabal.readthedocs.io/en/stable/cabal-package.html#package-descriptions)
